...
const emailTemplate = (emailBody) => {
  ...
  // footer email
  const footer = `<footer style="background: #1E88E5; padding: 10px; text-align: center; color: white;"><h5>Real Estate MarketPlace</h1><br/> <p>© 2023 Real Estate MarketPlace - All rigths reserved</p></footer>`;
